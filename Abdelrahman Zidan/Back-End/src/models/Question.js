...
class Question {
  // Create new question
  static async create({ categoryId, questionAr, questionEn, answerAr, answerEn, points = 200, difficulty = 'easy', imageUrl = null, answerImageUrl = null }) {
    const result = await query(
      `INSERT INTO questions (category_id, question_ar, question_en, answer_ar, answer_en, points, difficulty, image_url, answer_image_url) 
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [categoryId, questionAr, questionEn, answerAr, answerEn, points, difficulty, imageUrl, answerImageUrl]
    );
