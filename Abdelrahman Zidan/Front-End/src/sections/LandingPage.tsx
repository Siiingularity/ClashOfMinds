...
import { allCategories, powerUps } from '@/data/categories';
...
export function LandingPage({ 
  ...
  // Get random categories for display (mixed without sections)
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            ...
            >
              {language === 'ar' ? `عرض جميع الفئات (${allCategories.length})` : `View all categories (${allCategories.length})`}
            </button>
          </div>
        </div>
      </section>
