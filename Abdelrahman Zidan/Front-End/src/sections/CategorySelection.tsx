                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            setShowInfo(category as Category);
                          }}
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-3 pt-10">
                          ...
                          <p className="text-white/70 text-center text-xs transform rotate-180">
                            {category.count || 6}
                          </p>
                        </div>
                      </div>
                ...
                <div className="flex gap-2 overflow-x-auto flex-1 pb-1">
                  {selectedCategories.map((cat) => (
                    ...
                    >
                      ...
                      <div className="absolute bottom-1 left-1/2 -translate-x-1/2 bg-black/60 text-white text-xs px-2 py-0.5 rounded-full transform rotate-180">
                        {cat.count || 6}
                      </div>
                      {/* Remove button */}
                      <button 
